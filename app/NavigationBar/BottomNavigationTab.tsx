                ...
                tabBarIcon: ({ focused }) => (
                    <View style={{ alignItems: 'center', justifyContent: 'center', top: 5}}>
                        <Image 
                         ...
                         />
                         <Text style={{ color: focused ? '#0066FF' : 'gray', fontSize: 12 }}>Sets</Text>
                    </View>
                ),
            }}
            />
                ...
                tabBarIcon: ({ focused }) => (
                    <View style={{ alignItems: 'center', justifyContent: 'center', top: 5}}>
                        <Image 
                         ...
                         />
                         <Text style={{ color: focused ? '#0066FF' : 'gray', fontSize: 12 }}>Study</Text>
                    </View>
                ),
            }}
            />
                ...
                tabBarIcon: ({ focused }) => (
                    <View style={{ alignItems: 'center', justifyContent: 'center', top: 5}}>
                        <Image 
                         ...
                         />
                         <Text style={{ color: focused ? '#0066FF' : 'gray', fontSize: 12 }}>Insights</Text>
                    </View>
                ),
            }}
            />
                ...
                tabBarIcon: ({ focused }) => (
                    <View style={{ alignItems: 'center', justifyContent: 'center', top: 5}}>
                        <Image 
                         ...
                         />
                         <Text style={{ color: focused ? '#0066FF' : 'gray', fontSize: 12 }}>Profile</Text>
                    </View>
                ),
            }}
            />
